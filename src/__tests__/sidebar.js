...
import SideDrawerDefault, { SideDrawer } from '../components/Sidebar/SideDrawer/SideDrawer';
import LeftSideDefault, { LeftSide } from '../views/Dashboard/sidebar/LeftSide';
import RightSide from '../views/Dashboard/sidebar/RightSide';
import TopLeftSide from '../views/Dashboard/sidebar/TopLeftSide';
import TopRightSideDefault, { TopRightSide } from '../views/Dashboard/sidebar/TopRightSide';
import TopSide from '../views/Dashboard/sidebar/TopSide';
import SidebarDefault, { Sidebar } from '../views/Dashboard/sidebar/index';
