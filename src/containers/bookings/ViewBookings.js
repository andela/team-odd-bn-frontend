                  ...
                  oneItem={(booking, index) => (
                    <div key={index} className="singleBooking">
                      ...
                      >
                        <img
                          src={
                            booking.room.accommodation.imagesAccommodation[0]
                              .imageUrl
                          }
                        />
                      </div>
                      <div className="bookingDetails">
                        ...
                        <div className="cityBooking">
                          ...
                          <p>{booking.room.accommodation.city.city}</p>
                        </div>
                        ...
                        <div className="booking-like-contents">
                          ...
                          <section className="common-content likes_dislikes_data">
                            ...
                            <span className="dislikes_side">
                              {booking.dislikeCounter}
                            </span>
                          </section>

                          <div className="rateBookingsBtn">
                            <button
                              className="rateBookingBtn"
                              type="button"
